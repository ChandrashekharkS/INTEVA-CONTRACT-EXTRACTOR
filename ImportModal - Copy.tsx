              ...
              <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                    />
                    <p className="text-xs text-gray-500 mt-1">The model to use for extraction (e.g., `mistral:latest`, `llama3`).</p>
                  </div>
                   <div>
                  ...
                  <div>
                    ...
                    <div className="text-xs mt-1 h-4 flex items-center">
                        {connectionStatus === 'untested' && <span className="text-gray-500">Test the connection to your local AI server.</span>}
